...
**Ceph**: Execute `.semaphoreci/test_ceph.sh` from any directory within the Git repository.
**Minio**: Execute `.semaphoreci/test_minio.sh` from any directory within the Git repository.
