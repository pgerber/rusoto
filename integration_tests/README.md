...
**Ceph**: Execute `.semaphoreci/test_20_ceph.sh` from any directory within the Git repository.
**Minio**: Execute `.semaphoreci/test_30_minio.sh` from any directory within the Git repository.
